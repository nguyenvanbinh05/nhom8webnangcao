...
@section('content')
    <div class="content__body">
        <h1 style="font-size: 3rem; margin-bottom: 30px; color: dodgerblue;">Thêm sản phẩm mới</h1>
        ...
        <form action="{{ route('adminProduct.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="product-form__group">
                <div class="product-form__field">
                    <label class="product-form__label" for="productName"><span style="color: red">* </span>Tên sản
                        phẩm</label>
            ...
            <div class="product-form__group">
                <div class="product-form__field">
                    ...
                    <div class="product-form__image-box" id="mainImageBox">
                        <input class="product-form__file" type="file" id="mainImage" name="MainImage" accept="image/*">
                ...
                <div class="product-form__field">
                    ...
                    <div class="product-form__additional-images">
                        <input class="product-form__file" type="file" id="additionalImage" name="additationImages[]"
